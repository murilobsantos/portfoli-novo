...
export const devlogEntries: DevlogEntry[] = [
  {
    ...
    nextStep: "Fazer teste manual de teclado, ataque, habilidades e leitura de profundidade nas cinco salas; depois balancear o loop para uma sessão de 10 a 15 minutos.",
    icon: "⚔️",
    current: true,
  },
  {
