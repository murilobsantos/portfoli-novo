...
export const devlogEntries: DevlogEntry[] = [
  {
    ...
    highlights: [
      ...
      "O cenário evoluiu para tiles de 64px com chão, paredes e props, colisão AABB, ambiência roxa e profundidade por coordenada Y para leitura de RPG clássico.",
      "A matriz do mapa foi consolidada como grade bidimensional 15×10 por sala: bordas sólidas, colisão derivada dos blocos de 64px e desenho do terreno somente quando a sala muda.",
      "Os caminhos estáveis assets/tile_chao.png e assets/tile_parede.png agora alimentam o renderizador; os tiles provisórios evitam 404 até que os PNGs aprovados do Retro Diffusion os substituam.",
      "A integração visual ganhou peso de RPG: Viajante em 64×96px, ordenação pela base no eixo Y, pilastras com fundação sólida, tochas luminosas e vinheta/iluminação ambiente sobre a câmara.",
      "O controle deixou de saltar por células: posição contínua em pixels, delta time, colisão por eixo e troca atômica entre idle e caminhada mantêm sprites e física sincronizados.",
      "Ataque, dano, salto/teleporte e habilidades deixaram de competir com o Idle: cada ação agora preserva a própria linha, duração e bloqueio de movimento; paredes ganharam leitura top-down em camadas.",
      "Retro Diffusion gerou e aprovou o primeiro kit de cenário do Panteão Quebrado: piso, parede, tocha ciano e pilastra de obsidiana; somente os assets selecionados foram promovidos ao jogo.",
      "O vertical slice mudou para plataforma lateral: gravidade, salto, câmera horizontal, plataformas, parallax de ruínas e estados separados de idle, caminhada, ataque, salto, dano e skill.",
      "O pulo ganhou altura variável e poeira de impacto; ataques agora disparam um rastro ciano de 150ms gerado no Retro Diffusion e espelhado pela direção do personagem.",
    ...
    nextStep: "Testar o percurso lateral das cinco salas e ajustar altura de salto, alcance de combate e leitura dos VFX antes de gerar frames de skill dedicados.",
    icon: "⚔️",
    current: true,
  },
  {
