...
export const devlogEntries: DevlogEntry[] = [
  {
    ...
    nextStep: "Fazer teste manual de teclado e travessia nas cinco salas, substituir os tiles provisórios pelos PNGs revisados do Retro Diffusion e balancear o loop para uma sessão de 10 a 15 minutos.",
    icon: "⚔️",
    current: true,
  },
  {
