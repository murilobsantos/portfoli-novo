...
export const devlogEntries: DevlogEntry[] = [
  {
    ...
    nextStep: "Testar o percurso lateral das cinco salas, ajustar altura de salto e distância de combate e gerar VFX/sprites de skill dedicados no Retro Diffusion.",
    icon: "⚔️",
    current: true,
  },
  {
