...
export const devlogEntries: DevlogEntry[] = [
  {
    ...
    nextStep: "Substituir os tiles provisórios pelos PNGs revisados do Retro Diffusion, testar a travessia completa até o Santuário e balancear o loop para uma sessão de 10 a 15 minutos.",
    icon: "⚔️",
    current: true,
  },
  {
