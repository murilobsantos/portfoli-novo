...
export const devlogEntries: DevlogEntry[] = [
  {
    ...
    nextStep: "Fazer teste manual de teclado, ataque e habilidades nas cinco salas; com RD_API_KEY disponível, gerar e revisar os tiles definitivos do Retro Diffusion antes do balanceamento do loop.",
    icon: "⚔️",
    current: true,
  },
  {
