...
export const devlogEntries: DevlogEntry[] = [
  {
    ...
    nextStep: "Substituir os tiles provisórios pelos PNGs revisados do Retro Diffusion, testar colisão e leitura de profundidade em cada sala e balancear o loop para uma sessão de 10 a 15 minutos.",
    icon: "⚔️",
    current: true,
  },
  {
