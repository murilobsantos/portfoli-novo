...
export default function SiteFooter() {
  return <footer className="site-footer">
    ...
    <div className="footer-bottom"><span>© 2026 Murilo Santos</span><span>Design & desenvolvimento com intenção.</span><a href="https://github.com" target="_blank" rel="noreferrer">GitHub ↗</a></div>
  </footer>;
}
